...
namespace EMS.Website.Migrations.ProjectDb
{
    ...
    [Migration("20190730021756_AddRelationExpensesAndMisc")]
    partial class AddRelationExpensesAndMisc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.Entity.Entities.MiscExpenses", b =>
                {
                    ...
                    b.Property<int>("TraveExpID");

                    b.HasKey("ID");

                    b.HasIndex("TraveExpID");
            ...
            modelBuilder.Entity("EMS.Entity.Entities.MiscExpenses", b =>
                {
                    b.HasOne("EMS.Entity.Entities.TravelExpenses", "TravelExpenses")
                        .WithMany("MiscExpenses")
                        .HasForeignKey("TraveExpID")
                        .OnDelete(DeleteBehavior.Restrict);
                });
